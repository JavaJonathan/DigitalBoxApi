  ...
  let dest = fs.createWriteStream('photo.pdf');
    ...
    await drive.files.get(
      ...
      .on('end', () => {
        ...
        getText("C:\\Users\\jonat\\Documents\\JSProjects\\DigitalBoxApi\\photo.pdf", response)
      })  
      .on('error', err => {
...
const shouldIgnore = (item) => item && item.R[0].T.toString() === 'Description%C2%A0' || item.text === 'Price' || item.text === 'Qty'
